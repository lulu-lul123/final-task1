...
const internalBtn = document.querySelector(".middle");
const geologyBtn = document.querySelector(".geology");

const overviewBtn2 = document.querySelector(".overview-2");
const internalBtn2 = document.querySelector(".internal-2");
const geologyBtn2 = document.querySelector(".geology-2");
